...
* onefile, not upx
nuitka .\src\screencap\snapshot\ScreenshotProvider.py --onefile --enable-plugin=pyside6 --noinclude-dlls=qt6pdf.* --noinclude-dlls=qt6network.*  --nofollow-import-to=PySide6.QtNetwork --python-flag=no_docstrings --python-flag=no_asserts --show-modules --show-modules-output=included_modules.txt --mingw64 --lto=yes
